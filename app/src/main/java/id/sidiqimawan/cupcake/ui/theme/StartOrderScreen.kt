...
fun StartOrderScreen(
    quantityOptions: List<Pair<Int, Int>>, // Daftar pilihan kuantitas (label ID dan nilai kuantitas)
    ...
    Column(
        ...
        // Kolom atas untuk gambar dan teks
        Column(
            ...
            Spacer(modifier = Modifier.height(dimensionResource(R.dimen.padding_medium)))
            Text(
                text = stringResource(R.string.order_cupcakes), // Teks judul layar
                style = MaterialTheme.typography.headlineSmall
            )
            Spacer(modifier = Modifier.height(dimensionResource(R.dimen.padding_small)))
        }
        // Kolom bawah untuk tombol pilihan kuantitas
        Column(
...
// Komponen tombol untuk memilih kuantitas
@Composable
...
fun StartOrderPreview() {
    CupcakeTheme { // Menggunakan tema aplikasi Cupcake
        StartOrderScreen(
